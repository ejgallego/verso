...
// KaTeX reports UTF-16 offsets. Convert them once here so Lean only deals in decoded-character spans.
...
if (texPrelude) {
  // Validate the prelude in isolation first so broken macro definitions are not misattributed to the body.
  try {
